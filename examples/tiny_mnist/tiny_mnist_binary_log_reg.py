...
model.save(file_name="tiny_mnist_binary_classification_v1")
interp = model.get_interpretation()
interp.plot_losses()

new_model = Sequential()
new_model.load(file_name="tiny_mnist_binary_classification_v1")
# model already compiled when loaded from serialized file
new_model.fit(data=data, epochs=100)
new_model.save(file_name="tiny_mnist_binary_classification_v2")
