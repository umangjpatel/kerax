...
def load_data() -> Dataloader:
    ...
    async def load() -> Dataloader:
        ...
        return Dataloader(train_data=(train_images, train_labels), val_data=(val_images, val_labels),
                          input_shape=input_shape, batch_size=1000, info=None)

    return asyncio.run(load())

# TODO : Provide iterator support to in-memory datasets
