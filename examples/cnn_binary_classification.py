...
model.compile(loss="binary_crossentropy", optimizer="sgd", lr=3e-03, bs=x_train.shape[0])
model.fit(inputs=x_train, targets=y_train, epochs=200, validation_data=(x_val, y_val))
